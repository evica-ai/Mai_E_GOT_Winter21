(() => {
  ...
  const sigils = document.querySelector('#navList'),
        ...
        progress = lightbox.querySelector('.progress');
        progressBar = lightbox.querySelector('.progress_filled');
        toggle = lightbox.querySelector('.toggle');
        skipButtons = lightbox.querySelectorALl('.data-skip');
        ranges = lightbox.querySelectorAll('.player__slider');
        ...
        function popLightBox(event) {
          ...
          if (event.target.className.includes('sigilContainer')) {
            ...
            setTimeout(function() {
              lightBox.classList.add('show-lightbox')}, 1000);
